...
Therefore, given that the cases of positive probability and zero probability of transitions covers the entirety of options, we see that $Q$ must be symmetric. 
